...
public class RegistrationService {
	...
	public static DiscoveryInformation performDiscoveryOnUserSuppliedIdentifier(String userSuppliedIdentifier) throws ConsumerException {
  ...
  public static String getReturnToUrl() {
    return "http://localhost:8088/forumdisplay.do";
  }
}
